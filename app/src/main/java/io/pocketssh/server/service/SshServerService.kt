...
import io.pocketssh.server.BuildConfig
import io.pocketssh.server.R
import io.pocketssh.server.config.SshConfig
import io.pocketssh.server.config.SshConfigRepository
import io.pocketssh.server.ssh.AndroidCommandResolvers
...
class SshServerService : Service() {
    ...
    companion object {
        private const val TAG = "PocketSSH"
